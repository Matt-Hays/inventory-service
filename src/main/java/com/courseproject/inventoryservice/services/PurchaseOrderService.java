...
public class PurchaseOrderService {
    ...
    public PurchaseOrder findPurchaseOrderById(UUID id) throws EntityNotFoundException {
    ...
    public PurchaseOrder updatePurchaseOrder(UUID id, PurchaseOrder purchaseOrder) throws EntityNotFoundException, OptimisticLockingFailureException {
    ...
    @Transactional
    public PurchaseOrder addLineItemToPurchaseOrder(UUID id, List<PurchaseOrderLineItem> lineItems)
            throws EntityNotFoundException, OptimisticLockingFailureException, IllegalArgumentException {
